<script lang="ts">
  ...
  <div class="max-w-2xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow p-6">
    ...
    <div class="space-y-6">
        ...
        <p class="mb-4 dark:text-gray-300">APIキーをお持ちでない場合<a href="{base}/get-api-key" class="text-blue-500 hover:underline">取得方法を見るe</a>.</p>
      ...
      <div class="pt-4 border-t border-gray-200 dark:border-gray-700">
        ...
        <Alert variant="destructive">
          <AlertDescription>
            注意：このアプリはAPIキー、投稿内容、およびその他すべてのデータをローカルストレージに保存しています。以下のボタンをクリックすると、すべてのデータが永久に削除されます。
          </AlertDescription>
        </Alert>
